...
2. Provision a [Neon](https://neon.tech) Postgres database (or any managed Postgres provider) and add `DATABASE_URL` and `DATABASE_URL_UNPOOLED` to your Vercel environment variables.
