...
The [Expense Analyzer](/tools/expense-analyzer) is specifically designed for this use case: upload receipts and expense data, get categorized output with totals by category.
...
- [Document Analyzer](/tools/document-analyzer) — upload any financial document and extract key information
- [Invoice Processor](/tools/invoice-processor) — structured extraction from invoices specifically

**For expense processing:**
- [Expense Analyzer](/tools/expense-analyzer) — categorize and review expense data
...
*Need to extract structured data from financial documents? Try the [Invoice Processor](/tools/invoice-processor) or [Document Analyzer](/tools/document-analyzer) — upload your document and get structured output in minutes.*
