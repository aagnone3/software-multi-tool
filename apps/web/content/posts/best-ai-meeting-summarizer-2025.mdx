...
Go to [/tools/meeting-summarizer](/tools/meeting-summarizer) and upload your audio or video file. Supported formats: MP3, MP4, M4A, WAV, OGG.
...
- **Use speaker separation first** — If you upload a recording with multiple speakers, run it through the [Speaker Separation tool](/tools/speaker-separation) first. The meeting summarizer will use speaker labels to attribute action items correctly.
