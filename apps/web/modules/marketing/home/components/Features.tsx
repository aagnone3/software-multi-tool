...
export const featureTabs: Array<{
...
}> = [
	{
		...
		icon: StarIcon,
		subtitle: "",
		description: "Each tool has clear and intuitive usage.",
		stack: [],
		image: heroImage,
		imageBorder: false,
		highlights: [
			{
				title: "Just Works",
				description: "The tools just work. No second guessing.",
				icon: WandIcon,
			},
			{
				title: "No Learning Curve",
				description:
					"You shouldn't have to read a manual to get started. Just use them and identify more complex applications as you go.",
				icon: ComputerIcon,
			},
			{
				title: "Mobile Friendly",
				description: "Use the tools on the go, from any device.",
				icon: MobileIcon,
			},
		],
	},
	{
		...
		icon: CloudIcon,
		subtitle: "",
		description: "Powerful by themselves, better together.",
		stack: [],
		image: heroImage,
		imageBorder: false,
		highlights: [
			{
				title: "Individual Benefit",
				description:
					"Each tool is powerful on its own, solving specific problems effectively.",
				icon: WandIcon,
			},
			{
				title: "Combinations FTW",
				description:
					"When you use the tools together, you can create even more powerful workflows.",
				icon: WandIcon,
			},
		],
	},
