...
interface ToolInsightsErrorBoundaryProps {
	error: Error & { digest?: string };
	reset: () => void;
}

export default function ToolInsightsErrorBoundary({
	error,
	reset,
}: ToolInsightsErrorBoundaryProps) {
	useEffect(() => {
		console.error("Tool insights page error:", error);
	}, [error]);
