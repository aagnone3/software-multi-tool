				...
				<section className="bg-gradient-to-b from-primary/5 to-background py-16 md:py-24">
					<div className="container max-w-4xl text-center">
						...
						<p className="mx-auto mt-6 max-w-2xl text-foreground/70 text-lg">
							See exactly how much time and money your team could
							save by automating repetitive document and analysis
							tasks with AI.
						</p>
					</div>
				</section>
							...
							<div className="space-y-8">
								...
								<div className="rounded-xl border border-border bg-card p-6">
									...
									<p className="mb-4 text-foreground/60 text-sm">
										Select all that apply. Estimates based
										on industry averages for small teams.
									</p>
								...
								<div className="sticky top-8 space-y-4">
									...
									<div className="rounded-xl bg-muted/50 p-4 text-xs text-foreground/50">
										...
										<ul className="space-y-1">
											<li>
												• AI reduces manual time by ~80%
												on selected tasks
											</li>
											<li>
												• Monthly hours based on
												industry averages for small
												teams
											</li>
											<li>
												• Platform pricing is
