...
For each skill, analyze against the checklist:
...
Otherwise, ask: Apply these changes to skill-name? (y/n/skip-all)
...
Automated skill review and improvement based on best practices.
