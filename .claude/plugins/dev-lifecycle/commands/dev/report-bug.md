---
description: Collect a structured bug report and create a bug ticket in Linear
---
...
3. **Create Issue** - Use Linear for ticket creation

> **Note:** New bug tickets are created in **Inbox** status by default.
> They need grooming via `/workflows:plan` before they can be worked on.
