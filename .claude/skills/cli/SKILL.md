...
See [patterns.md](patterns.md) for detailed implementation patterns including:

- Error handling with try/catch and dual human/JSON output
- JSON output support for scriptability (`--json` flag)
- Color coding semantics (chalk green/yellow/red/cyan)
