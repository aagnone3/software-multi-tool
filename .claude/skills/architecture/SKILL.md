...
- **Functions**: `apps/web/inngest/functions/` - 8 job processors (AI analysis, transcription, GDPR exports)
- **Client**: `apps/web/inngest/client.ts` - Typed event schemas
- **Serve Endpoint**: `apps/web/app/api/inngest/route.ts` - Function registration
...
For complete architecture, function patterns, and development guidance, see [background-jobs.md](background-jobs.md).
