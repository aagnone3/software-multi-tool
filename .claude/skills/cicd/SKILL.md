---
name: managing-cicd
description: Manages CI/CD pipeline, preview environments, and database branching. Covers GitHub Actions, Vercel deployments, Supabase preview branches, and Prisma-to-Supabase migration sync.
allowed-tools:
  - Read
  - Grep
  - Glob
