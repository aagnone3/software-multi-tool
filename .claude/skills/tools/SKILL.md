...
description: Tool registry and credit configuration including credit costs, rate limits, public/private access control, icon selection (Lucide), credit pack system, and middleware routing. Use when registering tools in config (not implementing backends - see sub-app skill).
allowed-tools:
  - Read
  - Edit
  - Write
